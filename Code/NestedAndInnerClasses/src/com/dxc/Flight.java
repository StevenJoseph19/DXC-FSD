...
public class Flight implements Comparable<Flight>, Iterable<Passenger> {
	...
	// i.e. 12:15am - > 15 (15 min after midnight), 1:30 am - > 90 (90 min after
	// midnight), etc.
	...
	public int compareTo(Flight flight) {
		// Flights are sorted by time of day. Ordering starts with those just after
		// midnight and
		// continuing through the rest of the day. (i.e. 15 (12:15am) comes before 90
		// (1:30am)
