...
public class ArrayRangeQueries {
	...
	public static void main(String[] args) {
		...
		// Create a map of all integers with their frequencies
		...
		final var integerFrequenciesSorted = integerFrequencies.entrySet().stream()
