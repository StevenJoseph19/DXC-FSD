package collections.singlylinkedlist;
...
public class LinkedList {
	 ...
	 * the value at position 0. If the position is greater than the size of the
	 * list, remove the value at the last position.
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println(" Tail of the linked list : " + linkedList.getLast());
		System.out.println(" Postion of the node with data 10 : " + linkedList.getPosition(10));
