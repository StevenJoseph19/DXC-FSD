...
public class UserInfoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<h3>Reading Query String data using 'Enumeration getParameterNames() method : </h3>");
		...
		out.println("<h3>Reading Query String data using 'Map getParameterMap() method : </h3>");
		out.println("<div>");
