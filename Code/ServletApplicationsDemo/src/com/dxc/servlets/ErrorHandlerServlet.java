...
public class ErrorHandlerServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String errorMessage = (String) request.getAttribute("javax.servlet.error.message"); // Removed whitespace from attribute name
		String requestURI = (String) request.getAttribute("javax.servlet.error.request_uri");// Removed whitespace from attribute name
