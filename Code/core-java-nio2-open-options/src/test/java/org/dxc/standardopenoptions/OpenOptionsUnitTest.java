package org.dxc.standardopenoptions;
...
public class OpenOptionsUnitTest {
	...
	private static final String ANOTHER_DUMMY_TEXT = "This is another text";

	@BeforeClass
	public static void beforeAll() throws IOException {
		System.out.println(CURR_DIR);
		Path path = Paths.get(CURR_DIR, DUMMY_FILE_NAME);

		try (OutputStream out = Files.newOutputStream(path)) {
			out.write(DUMMY_TEXT.getBytes());
		}

		Files.createFile(Paths.get(CURR_DIR, EXISTING_FILE_NAME));
	}

	@AfterClass
	public static void afterAll() throws IOException {

		Files.delete(Paths.get(CURR_DIR, "newfile.txt"));
		Files.delete(Paths.get(CURR_DIR, "sparse.txt"));
		Files.delete(Paths.get(CURR_DIR, DUMMY_FILE_NAME));
//		Files.delete(Paths.get(CURR_DIR, EXISTING_FILE_NAME));
	}

	@Test
	public void givenExistingPath_whenCreateNewFile_thenCorrect() throws IOException {
		Path path = Paths.get(CURR_DIR, "newfile.txt");
	...
	public void givenExistingPath_whenCreateSparseFile_thenCorrect() throws IOException {
		Path path = Paths.get(CURR_DIR, "sparse.txt");
	...
	public void givenExistingPath_whenWriteAndSync_thenCorrect() throws IOException {
		...
		Files.write(path, ANOTHER_DUMMY_TEXT.getBytes(), StandardOpenOption.APPEND, StandardOpenOption.WRITE,
				StandardOpenOption.SYNC);
	}

	@Test
	public void givenExistingPath_whenDeleteOnClose_thenCorrect() throws IOException {
		Path path = Paths.get(CURR_DIR, EXISTING_FILE_NAME);
